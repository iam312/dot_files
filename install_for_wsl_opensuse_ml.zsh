...
sudo zypper install -y  git-core tmux zsh vim vim-data wget curl curl-zsh-completion tar make gcc gcc-c++ ruby zlib-devel libopenssl-devel ncurses-utils glibc-locale youtube-dl readline-devel libbz2-devel libsqlite3-0 sqlite3-devel graphviz baekmuk-ttf-fonts
